...
const UserEditor: React.FC<UserEditorProps> = ({
  ...
  if (mode === "view" && user) {
    const canEdit =
      userRole === "root" || (userRole === "manager" && user.role !== "root");
        ...
        <div className="editor-form">
          ...
          <div className="form-group">
            <label htmlFor="password">
              Пароль{" "}
              {mode === "create" ? "*" : "(оставьте пустым, чтобы не менять)"}
            </label>
            <input
              type="password"
              id="password"
          ...
          <div className="form-info">
            ...
            <ul>
              <li>
                <strong>Пользователь:</strong> Только чтение документации
              </li>
              <li>
                <strong>Менеджер:</strong> Управление документами + чтение
              </li>
              <li>
                <strong>Администратор:</strong> Полные права (включая управление
                пользователями)
              </li>
            </ul>
          </div>
