                    ...
                    {[1, 2, 3, 4].map((i) => (
                        ...
                        >
                            <div className="text-sm text-gray-500 flex items-center gap-2 mb-1">
                                📅 22.02.2025 | Автор Обучения
                            </div>
                            <h3 className="font-semibold text-lg mb-2">Название урока {i}</h3>
                            <p className="text-gray-600">
                                Первые строки обучающего материала. Продолжение будет на отдельной странице...
                            </p>
                        </div>
                    ))}
                </div>
